...
import ieltsPic from '../../Assets/student3.jpg'
    ...
    return (
        <div>
            ...
            <div className="flex max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
                <div className="hidden bg-cover opacity-90 lg:block lg:w-1/2 login-bg-img">
                    <img className='fluid mx-auto' src={ieltsPic} alt="" />
                </div>

                <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                    <h2 className="text-2xl font-bold text-center text-rose-600 dark:text-white">IELTS Proficiency</h2>
                    ...
                    <div className="flex items-center justify-between mt-4">
                        ...
                        <Link to={'/register'} className="text-sm text-gray-600  dark:text-gray-400 hover:underline">OR REGISTER</Link>
