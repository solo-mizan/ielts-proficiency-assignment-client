    ...
    return (
        <div>
            ...
            <div class="w-full max-w-sm p-6 m-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                <h1 class="text-3xl font-semibold text-center text-gray-700 dark:text-white">Welcome to <span className='font-bold text-rose-600'>IELTS Proficiency!</span></h1>
                ...
                <p class="mt-8 text-sm font-light text-center text-gray-600"> Already have an account? <Link to={'/login'}
